...
export const Definitions = {
  ...
  help_overlay_toggle: keybind("ctrl+g", "Toggle keybinding help overlay"),
  ...
  sidebar_toggle: keybind("<leader>b,ctrl+l", "Toggle sidebar"),
  sidebar_tab_toggle: keybind("ctrl+y", "Toggle sidebar tab (Info / Project files)"),
  ...
  // Port: default was ctrl+b; freed so the split-pane toggle can own ctrl+b.
  session_background: keybind("none", "Background synchronous subagents"),
  ...
  // Port: split pane (secondary view beside the transcript) and sidebar extras.
  session_split_toggle: keybind("ctrl+b", "Toggle split pane"),
  session_split_tab_cycle: keybind("ctrl+q", "Cycle split pane tabs"),
  session_split_tab_1: keybind("ctrl+1", "Split pane: agents tab"),
  session_split_tab_2: keybind("ctrl+2", "Split pane: terminal tab"),
  session_split_tab_3: keybind("ctrl+3", "Split pane: files tab"),
  session_split_tab_4: keybind("ctrl+4", "Split pane: plan tab"),
  session_split_grow: keybind("ctrl+right", "Grow transcript side of split pane"),
  session_split_shrink: keybind("ctrl+left", "Shrink transcript side of split pane"),
  ...
  // Port: default was ctrl+g,home; ctrl+g freed for the keybinding help overlay.
  messages_first: keybind("home", "Navigate to first message"),
  ...
  // Port: default was left,ctrl+b; ctrl+b freed for the split-pane toggle.
  input_move_left: keybind("left", "Move cursor left in input"),
...
export const CommandMap = {
  ...
  help_show: "help.show",
  help_overlay_toggle: "help.overlay",
  docs_open: "docs.open",
  diff_open: "diff.open",
  ...
  sidebar_tab_toggle: "session.sidebar.tab.toggle",
  ...
  session_split_tab_cycle: "session.split.tab.cycle",
  session_split_tab_1: "session.split.tab.1",
  session_split_tab_2: "session.split.tab.2",
  session_split_tab_3: "session.split.tab.3",
  session_split_tab_4: "session.split.tab.4",
  session_split_grow: "session.split.grow",
  session_split_shrink: "session.split.shrink",
