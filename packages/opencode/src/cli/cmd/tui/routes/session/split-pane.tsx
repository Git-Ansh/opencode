...
export function SplitPane(props: ParentProps<{
  width: number
  height: number
      ...
      <Show when={props.secondary() !== "none"}>
        ...
        <box width={secondaryWidth()} height={props.height}>
          ...
          >
            ...
            <text
              fg={theme.textMuted}
              onMouseDown={() => props.setSecondary("none")}
            >
              {"\u2715"}
            </text>
          </box>
          ...
          <box flexDirection="row" flexShrink={0} gap={2} paddingLeft={1} paddingRight={1}>
            <text fg={theme.text}>{"ctrl+\u2191\u2193"} <span style={{ fg: theme.textMuted }}>nav</span></text>
            <text fg={theme.text}>ctrl+q <span style={{ fg: theme.textMuted }}>tab</span></text>
            <text fg={theme.text}>ctrl+w <span style={{ fg: theme.textMuted }}>list</span></text>
            <text fg={theme.text}>ctrl+f <span style={{ fg: theme.textMuted }}>filter</span></text>
            <text fg={theme.text}>ctrl+o <span style={{ fg: theme.textMuted }}>close</span></text>
          </box>
        </box>
      </Show>
    </box>
